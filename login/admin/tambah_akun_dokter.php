...
<head>
  ...
  <title>Tambah Akun Dokter</title>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <button type="button" class="btn btn-success" onClick="history.go(0)"><i class="fa fa-refresh"></i> Refresh </button>
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Data Akun Dokter</h4>
                  <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#pasien"><i class="mdi mdi-plus"></i> Tambah Akun Dokter</button>
     ...
     <?php
      ...
      $query =mysqli_query($konek,"SELECT * FROM user_lv INNER JOIN user ON user.level=user_lv.level
       where nm_level='Dokter' order by kode DESC");
      $i = 1;
      while($fetch = mysqli_fetch_array($query))
      {
      echo"
          <tr align=center>
              <td>$i.</td>
                ...
                <td>$fetch[email]</td>
                <td><a href=\"tambah_akun_dokter_edit.php?kode=$fetch[kode]\"> <button type='button' class='btn btn-outline btn-primary'>Edit<i class='fa  fa-edit'></i></button>  </a>
