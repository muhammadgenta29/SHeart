...
<head>
  ...
  <title>Tambah Akun Pasien</title>
...
<body>
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <button type="button" class="btn btn-warning" onClick="history.go(-1)"><i class="fa fa-rotate-left"></i> Back </button>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#pasien"><i class="mdi mdi-plus"></i> Tambah Akun Pasien</button>
     ...
     <?php
      include('../server.php');
      $query =mysqli_query($konek,"SELECT * FROM user_lv INNER JOIN user ON user.level=user_lv.level
       where nm_level='Pasien' order by kode DESC");
      $i = 1;
      while($fetch = mysqli_fetch_array($query))
      {
      echo"
          <tr align=center>
              <td>$i.</td>
                ...
                <td>$fetch[email]</td>
                <td><a href=\"tambah_akun_pasien_edit.php?kode=$fetch[kode]\"> <button type='button' class='btn btn-outline btn-primary'>Edit<i class='fa  fa-edit'></i></button>  </a>
                <a href=\"tambah_akun_pasien_hapus.php?kode=$fetch[kode]\"> <button type='button' class='btn btn-outline btn-danger'>Hapus<i class='fa  fa-close'></i></button>  </a></td>
          </tr>
      ";
      $i++; 
        }
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <h4 style="font-size:20px" class="modal-title" id="myModalLabel">Tambah Akun Pasien</h4>
        ...
        <div class="panel-body">
            ...
            <div class="col-lg-8">
                <form action="tambah_akun_pasien_post.php" method="post" enctype="multipart/form-data">  
                <?php 
            include '../server.php';
