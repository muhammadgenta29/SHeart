...
<body>
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="data_grafik.php">
  ...
  <!-- plugins:js -->
  <script src="grafik/jquery-latest.js"></script>       
  <script type="text/javascript" src="grafik/asset/js/jquery-3.4.0.min.js"></script>
  <script type="text/javascript" src="grafik/asset/js/mdb.min.js"></script>
  <script src="grafik/asset/js/jquery.min.js"></script>
  <script src="grafik/asset/js/bootstrap.min.js"></script>
