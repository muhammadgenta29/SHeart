...
<body>
  ...
  <a href="tambah_akun_dokter.php" class="list-group-item list-group-item-action">1. Dokter</a>
  <a href="tambah_akun_pasien.php" class="list-group-item list-group-item-action">2. Pasien</a>
</div>
                  </div>
                </div>
              </div>
