        ...
        <div class="content-wrapper">
              <div class="card">
                <div class="card-body">
                  ...
                  <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#pasien"><i class="mdi mdi-plus"></i> Tambah Biodata Pasien</button>
      ...
      echo"
          <tr align=center>
              <td>$i.</td>
                ...
                <td>$fetch[jk]</td>
                <td><a href=\"pasien_detail.php?id_biodata=$fetch[id_biodata]\"> <button type='button' class='btn btn-outline btn-success'>Detail<i class='fa  fa-edit'></i></button>  </a>
                <a href=\"pasien_edit.php?id_biodata=$fetch[id_biodata]\"> <button type='button' class='btn btn-outline btn-primary'>Edit<i class='fa  fa-edit'></i></button>  </a>
                <a href=\"pasien_hapus.php?id_biodata=$fetch[id_biodata]\"> <button type='button' class='btn btn-outline btn-danger'>Hapus<i class='fa  fa-close'></i></button>  </a></td>
          </tr>
      ";
      $i++; 
        }
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <h4 style="font-size:20px" class="modal-title" id="myModalLabel">Tambah Biodata Pasien</h4>
