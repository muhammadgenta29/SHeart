...
if(isset($_POST['ubah_foto'])){ // Jika user menceklis checkbox yang ada di form ubah, lakukan :
  ...
  if(move_uploaded_file($nama_gambar, $path)){ // Cek apakah gambar berhasil diupload atau tidak
      ...
      if(is_file("../pasien/gambar/".$data['foto'])) // Jika gambar ada

          unlink("../pasien/gambar/".$data['foto']); // Hapus file gambar sebelumnya yang ada di folder images
