...
<div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        ...
        $query = mysqli_query($konek,"SELECT * FROM user where email='$_SESSION[Pasien]' ");
        $i = 1;
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" role="form" action="biodata_edit_post.php" method="post" enctype="multipart/form-data" >
                  <?php include('../server.php');
                    ...
                    <div class="form-group">
                      <label>Foto</label><br>
                      <a href="gambar/<?php echo $fetch['foto'] ?>"><img src="gambar/<?php echo $fetch['foto'] ?>" width="150px" height="120px" /></a></br>
