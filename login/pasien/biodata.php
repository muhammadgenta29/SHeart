              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <?php include('../server.php');
                      ...
                      while($fetch = mysqli_fetch_array($query))
                      { ?>  
                  <a href="biodata_edit.php?id_biodata=<?php echo $fetch["id_biodata"];?>"> <button type='button' class='btn btn-outline btn-success'>Edit<i class='fa  fa-edit'></i></button>  </a>
                  ...
                  <div class="table-responsive pt-3">
                    <table  class="table table-striped table-bordered">
                      ...
                      <tr align="center">
                          <th>Foto</th>
                          <th> : </th>
                          <td><?php echo "<a href=gambar/$fetch[foto]><img src=\"gambar/$fetch[foto]\" width=\"150px\"/>" ?></a></td>
                        </tr>
                        <tr align="center">
                          <th>NIK</th>
                          <th> : </th>
