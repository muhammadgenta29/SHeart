...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="../assets/" type="image/png"><!-- Font Awesome -->
                    ...
                    <div class="card shadow zindex-100 mb-0">
                        <div class="card-body px-md-5 py-5">
                            ...
                            <form role="form" action="login_post.php" method="post">
                                ...
                                <div class="mt-4">
                                    <input type="submit" name="login" class="btn btn-block btn-primary">Sign in</div>
                            </form>
                        </div>
                        <div class="card-footer px-md-5"><small>Belum Punya Akun?</small>
                            <a href="daftar.php" class="small font-weight-bold">Daftar</a></div>
                    </div>
                </div>
            </div>
        </div>
