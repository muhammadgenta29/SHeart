    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <button type="button" class="btn btn-success" onClick="history.go(0)"><i class="fa fa-refresh"></i> Refresh </button>
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Data Grafik Utama</h4>
     ...
     <?php
      include('../server.php');
      $query =mysqli_query($konek,"SELECT * FROM grafik
      INNER JOIN user ON user.kode=grafik.kode WHERE level='3' ORDER BY id DESC");
      $i = 1;
      while($fetch = mysqli_fetch_array($query))
      {
      echo"
          <tr align=center>
              <td>$i.</td>
                ...
                <td><a href=\"grafik.php?kode=$fetch[kode]\"> <button type='button' class='btn btn-outline btn-primary'>Lihat Grafik<i class='fa  fa-edit'></i></button>  </a></td>
          </tr>
      ";
      $i++; 
        }
